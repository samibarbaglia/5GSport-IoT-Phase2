...
class GATTSensorDataClient FINAL : private wb::ResourceClient,
 ...
 private:
  ...
  virtual void onPostResult(wb::RequestId requestId, wb::ResourceId resourceId,
                            wb::Result resultCode,
                            const wb::Value& rResultData) OVERRIDE;

  /** @see whiteboard::ResourceClient::onGetResult */
  virtual void onGetResult(wb::RequestId requestId, wb::ResourceId resourceId,
  ...
  virtual void onNotify(wb::ResourceId resourceId, const wb::Value& rValue,
